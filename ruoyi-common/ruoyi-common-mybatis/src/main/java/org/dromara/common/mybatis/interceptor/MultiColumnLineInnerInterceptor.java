...
//import org.dromara.common.mybatis.handler.MultiColumnLineHandler;
//
...
//public class MultiColumnLineInnerInterceptor extends BaseMultiTableInnerInterceptor implements InnerInterceptor {
//
//    private MultiColumnLineHandler multiColumnLineHandler;
//
//    @Override
...
//        if (multiColumnLineHandler.ignoreTable(insert.getTable().getName())) {
//            // 过滤退出执行
//            return;
//        }
...
//            return;
//        }
//        String columnName = multiColumnLineHandler.getColumnName();
//        if (multiColumnLineHandler.ignoreInsert(columns, columnName)) {
//            // 针对已给出租户列的insert 不处理
//            return;
//        }
...
//            equalsTo.setRightExpression(multiColumnLineHandler.getColumnValues());
...
//            Expression tenantId = multiColumnLineHandler.getColumnValues();
...
//        if (multiColumnLineHandler.ignoreTable(table.getName())) {
//            // 过滤退出执行
//            return;
//        }
...
//        if (multiColumnLineHandler.ignoreTable(delete.getTable().getName())) {
//            // 过滤退出执行
//            return;
//        }
...
//            }
//        }
//        selectItems.add(new SelectExpressionItem(new Column(multiColumnLineHandler.getColumnName())));
//    }
//
//    /**
//     * 租户字段别名设置
...
//        }
//        column.append(multiColumnLineHandler.getColumnName());
//        return new Column(column.toString());
//    }
//
//    @Override
//    public void setProperties(Properties properties) {
//        PropertyMapper.newInstance(properties).whenNotBlank("multiColumnLineHandler",
//            ClassUtils::newInstance, this::setMultiColumnLineHandler);
//    }
//
//    /**
//     * 构建租户条件表达式
...
//            return null;
//        }
//        //return new EqualsTo(getAliasColumn(table), multiColumnLineHandler.getColumnValues());
//        InExpression inExpression = new InExpression();
//        inExpression.setLeftExpression(getAliasColumn(table));
//        inExpression.setRightExpression(getAliasColumn(table));
//        return  new EqualsTo(getAliasColumn(table), multiColumnLineHandler.getColumnValues());
//    }
//}
