...
import org.dromara.platform.mapper.AppTagMapper;
...
@Service
public class AppTagService implements IBaseService<AppTag, AppTagVo, AppTagBo> {
    ...
    public Boolean insertByBo(AppTagBo bo) {
        ...
        AppSubjectVo appSubjectVo = appSubjectService.queryById(bo.getSubjectId());
    ...
    public Boolean updateByBo(AppTagBo bo) {
        ...
        update.setAppId(appSubjectVo.getAppId());
